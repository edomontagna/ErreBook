    ...
    <footer className="bg-forest-deep">
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.4em] text-white/50">{t.footer.explore}</h3>
            <ul className="mt-5 space-y-3 text-sm">
              {[{ l: t.footer.properties, h: "/properties" }, { l: t.footer.aboutUs, h: "/about" }, { l: t.footer.contactUs, h: "/contact" }].map((lnk) => (
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.4em] text-white/50">{t.footer.contacts}</h3>
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.4em] text-white/50">{t.footer.newsletter}</h3>
            <p className="mt-5 text-sm font-light text-white/30">{t.footer.newsletterDesc}</p>
            <div className="mt-4 flex gap-0">
              <Input type="email" placeholder={t.footer.emailPlaceholder} className="h-9 rounded-none border-white/10 bg-white/[0.04] text-sm text-white placeholder:text-white/20" />
        ...
        <div className="mt-16 flex flex-col items-center gap-3 border-t border-white/[0.05] pt-8 sm:flex-row sm:justify-between">
          <p className="text-xs font-light text-white/20">&copy; {new Date().getFullYear()} {siteConfig.company.name}. {t.footer.rights}</p>
